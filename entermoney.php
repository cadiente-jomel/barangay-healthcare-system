...
<div class="main_panel">
   <div class="content">
     ...
     <div class="row">
            <div class="col-md-4">
                <h2 class="text-center">Money Entered</h2>
                <hr><br>
                <form action="process4.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="amount">Amount1</label>
                        <input type="text" name="amount" class="form-control" id="amount" placeholder="Enter Amount" required  value="<?php echo $amount1; ?>">
                    </div>
                    <?php if($update == true): ?>
            ...
            <div class="col-md-8">
            <h2 class="text-center">Total Money : Php <?php echo $total2;?></h2>
                <h2 class="text-center">Total Money : Php <?php echo $total1;?></h2>
